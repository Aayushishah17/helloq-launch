...
const screens = [
  { img: phoneProfile, label: "Profile", floatDuration: 4, floatDelay: 0, rotation: [-1.5, 1.5, -1.5] },
  { img: phoneDiscover, label: "Discover", floatDuration: 5, floatDelay: 0.4, rotation: [1, -1, 1] },
  { img: phoneChat, label: "Chat", floatDuration: 3.5, floatDelay: 0.8, rotation: [1.5, -1.5, 1.5] },
];
...
const PhoneCarousel = () => {
  return (
    <section className="py-32 overflow-hidden relative" id="experience">
